...
<script>
import HeaderLayout from "../../layouts/HeaderLayoutRu/HeaderLayout.vue";
...
import FooterLayout from "../../layouts/FooterLayoutRu/FooterLayout.vue";
import FooterBottomLayout from "../../layouts/FooterBottomLayoutRu/FooterBottomLayout.vue";
export default {
  components: {
    HeaderLayout,
    HeroSection,
