  ...
  methods: {
    validatedForm() {
      ...
      if (this.username.length === 0) {
        isValid = false;
        this.error.nameError = "*Enter here your full-name";
      } else {
        isValid = true;
    ...
    validatedFormSecond() {
      ...
      if (this.tel.length <= 4) {
        isValidSecond = false;
        this.errorSecond.nameErrorSecond = "*Enter here your number";
    ...
    validatedFormThird() {
      ...
      if (this.message.length === 0) {
        isValidThird = false;
        this.errorThird.nameErrorThird = "*Enter here your message";
      } else {
        isValidThird = true;
    ...
    async sendData(name, tel, message) {
      ...
      const info = `User: %0A<strong>Full-name:</strong> ${name} %0A<strong>Phone Number:</strong> ${tel} %0A<strong>Message:</strong> ${message}`;
