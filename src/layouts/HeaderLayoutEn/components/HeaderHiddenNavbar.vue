<template>
  ...
  >
    <nav
      class="nav w-full h-[620px] pt-[78px] z-[999] bg-white rounded-b-[40px] dark:bg-tailwind-dark fixed px-4 mx-auto top-0 md:px-10 md:py-[16px] md:h-[800px] md:pt-[68px] block lg:hidden overflow-y-auto overflow-hidden"
    >
      <hr />
