<template>
  ...
  >
    <nav
      class="nav w-full h-[620px] pt-[78px] z-[999] bg-white rounded-b-[40px] dark:bg-tailwind-dark px-4 mx-auto top-0 md:px-10 md:py-[16px] md:h-[800px] md:pt-[68px] block lg:hidden overflow-y-auto overflow-hidden"
    >
      <hr />
      <ul class="ul flex flex-col gap-3 md:flex md:flex-col md:gap-5">
        ...
        >
          ...
          <a class="link ml-4 w-full" href="#partnershipSecond">Партнерство</a>
          <i class="fa-solid dark:text-white fa-arrow-right-long fa-beat ml-0">
          </i>
        </li>
        <div
